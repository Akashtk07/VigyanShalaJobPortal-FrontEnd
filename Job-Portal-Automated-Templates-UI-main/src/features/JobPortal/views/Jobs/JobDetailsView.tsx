    ...
    <Box padding={5}>
      ...
      >
        <Box display="flex" alignItems="center" justifyContent="space-between">
          <Typography variant="h4" color={"#00396b"}>
            {job.jobTitle.jobTitle}{" "}
          </Typography>
          {sessionStorage.getItem("role")?.toLowerCase() === "admin" ? (
            <Link
              to={`/JobPortal/ManageJobs/Job/${job.jobId}/Edit`}
              state={{ edit: job }}
            >
              <StyledButton>EDIT</StyledButton>
            </Link>
          ) : (
            <StyledButton href={`${job.jobId}/Apply`}>APPLY</StyledButton>
          )}
        </Box>
        <Grid container display="flex" margin={"0 10% 0 0"}>
          ...
          <Grid item xs={12} md={3} display="flex">
            ...
            <Box padding="10px" alignItems="center">
              ...
              <Typography variant="body1">{job.workMode.workMode}</Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={3} display="flex">
          ...
          <Grid item xs={12} md={3} display="flex">
            ...
            <Box padding="10px" alignItems="center">
              ...
              <Typography variant="body1">{job.industry.industry}</Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={3} display="flex">
            <Box padding="10px" alignItems="center">
